...
import { ChevronRight, Play, Palette, Layers, Box, Menu, X, ArrowRight, Star, Zap, Shield, CheckCircle, Mail, Phone, MapPin, Linkedin, Instagram, Dribbble } from 'lucide-react';
...
const Portfolio3DHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
      {/* Header con effetto glassmorphism adattato per tema scuro */}
      <header
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            {/* Logo personalizzato - sostituisci con il tuo logo */}
            <div className="flex items-center space-x-2 flex-shrink-0 -ml-4">
              <div className="w-48 h-16 bg-contain bg-no-repeat bg-left"
                   style={{
            ...
            {/* Navigation Desktop - pulsanti ovali */}
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden backdrop-blur-xl border-t border-gray-700"
            style={{
              backgroundColor: 'rgba(31, 41, 55, 0.98)',
            }}>
            <nav className="px-4 py-6 space-y-4">
              <a href="#home" className="block py-2 text-gray-300 hover:text-white transition-all">
                Home
              </a>
              <a href="#servizi" className="block py-2 text-gray-300 hover:text-white transition-all">
                Servizi
              </a>
              <a href="#portfolio" className="block py-2 text-gray-300 hover:text-white transition-all">
                Portfolio
              </a>
              <button
      ...
      {/* Contenitore per l'immagine di sfondo persistente */}
      <div
      ...
      >
        <div className="absolute inset-0 w-full h-full overflow-hidden bg-gray-900">
          <img
            ...
            alt="Portfolio 3D Rendering Background"
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 min-h-full w-auto md:w-full md:h-auto md:max-h-full"
            style={{
              objectFit: 'cover',
              minWidth: '100%'
            }}
      ...
      {/* Hero Section - testo in sovraimpressione sulle immagini, spostato più in basso */}
          ...
          <div className="absolute bottom-0 left-0 right-0 pb-20 md:pb-28 lg:pb-36 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-2xl space-y-8">
              ...
              <p className="text-base md:text-lg text-gray-200 leading-relaxed max-w-xl">
                ...
                Specializzato nel settore mobile con anni di esperienza in modellazione 3D avanzata.
              </p>

              {/* Pulsante Guarda Showreel */}
              <div className="mt-8">
                <button
      ...
      {/* Servizi Section con tema scuro e sfondo dissolvente */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative flex">
              ...
              <div className="relative bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 flex flex-col w-full">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">Modellazione 3D</h3>
                <p className="text-gray-300 mb-6 flex-grow">
                  Creazione di modelli 3D ad alta precisione per ogni esigenza progettuale. Dal concept iniziale al modello finale ottimizzato per produzione o visualizzazione.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Modellazione CAD professionale</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Design di prodotto e packaging</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Ottimizzazione per stampa 3D</span>
                  </li>
                </ul>
              </div>
            </div>

            {/* Card 2 - Rendering Fotorealistico */}
            <div className="group relative flex">
              <div
                className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"
                style={{
              ...
              <div className="relative bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 flex flex-col w-full">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">Rendering Fotorealistico</h3>
                <p className="text-gray-300 mb-6 flex-grow">
                  Immagini fotorealistiche di altissima qualità che trasformano i tuoi modelli 3D in presentazioni professionali pronte per marketing e comunicazione.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Illuminazione studio professionale</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Materiali PBR avanzati</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Post-produzione cinematografica</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="group relative flex">
              ...
              <div className="relative bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-700 flex flex-col w-full">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">Scansione 3D</h3>
                <p className="text-gray-300 mb-6 flex-grow">
                  Acquisizione digitale precisa di oggetti reali trasformati in modelli 3D modificabili. Ideale per reverse engineering e digitalizzazione del patrimonio.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Scansione ad alta risoluzione</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Reverse engineering preciso</span>
                  </li>
                  <li className="flex items-center text-gray-200">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: brandColors.accent }} />
                    <span>Ricostruzione mesh ottimizzata</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      {/* Portfolio Preview Section con tema scuro */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 bg-gray-800 border border-gray-700">
                <div className="aspect-w-16 aspect-h-12">
                  <img
                    src={`https://images.unsplash.com/photo-${
                      item === 1 ? '1618005182384-a83a8bd57fbe' :
                      item === 2 ? '1633167606207-d840b5070fc2' :
                      item === 3 ? '1558618666-fcd25c85cd64' :
                      item === 4 ? '1635776062127-d379bfcba9f8' :
                      item === 5 ? '1614851099175-e5b30eb6f696' :
                      '1615486511484-92e172817c59'
                    }?w=600&h=400&fit=crop`}
                    alt={`Progetto ${item}`}
                    className="w-full h-[280px] object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                </div>
                {/* Overlay con tema scuro */}
                <div
                  className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-gray-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                >
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-xl font-bold mb-2 text-white">Progetto Mobile {item}</h3>
      ...
      {/* Footer con tema scuro */}
      <footer className="bg-gray-800 text-white py-16 border-t border-gray-700 z-10 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Brand - logo personalizzato */}
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-32 h-12 bg-contain bg-no-repeat bg-center"
                     style={{
                       backgroundImage: "url('/path-al-tuo-logo.png')",
                       backgroundSize: 'contain'
                     }}>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><a href="#" className="hover:text-white transition-colors">Modellazione 3D</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Rendering</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Animazione</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Consulenza</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400 text-sm">
            <p>© 2024 Portfolio Studio. Tutti i diritti riservati. | P.IVA: 00000000000</p>
          </div>
        </div>
      </footer>
    </div>
